...
function initRuntimeSocketService() {
  const hosts = "192.168.3.1,192.168.17.1,192.168.1.236,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_z2w9_B";
...
const pages = [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "寻找同路人"
    }
  },
  {
    path: "pages/ride-detail/ride-detail",
    style: {
